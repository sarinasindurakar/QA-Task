...
public class Relativexpathloginpagetest {
    ...
    private void verifyErrorMessage(String expectedErrorMessage) {
        ...
        WebElement errorElement = driver.findElement(By.xpath("//div[@class=\"next-feedback-content\"]"));
        String actualErrorMessage = errorElement.getText();
        Assert.assertEquals(actualErrorMessage, expectedErrorMessage);
    }
    private void verifyemptyMessage(String errorMessage){
        driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
        WebElement errorElement = driver.findElement(By.xpath("//div[@class=\"mod-login\"]//span"));
        String actualErrorMessage = errorElement.getText();
    ...
    private void verifyemptypassword(String errorpMessage){
        driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
        WebElement errorElement = driver.findElement(By.xpath("//div[@class=\"mod-input error mod-input-password mod-login-input-password mod-input-password\"]//span"));
        String actualErrorMessage = errorElement.getText();
