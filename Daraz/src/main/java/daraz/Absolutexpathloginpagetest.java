...
public class Absolutexpathloginpagetest {
    ...
    private void enterCredentials(String username, String password) {
        WebElement usernameInput = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div[2]/form/div/div[1]/div[1]/input"));
        WebElement passwordInput = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div[2]/form/div/div[1]/div[2]/input"));
    ...
    private void clickLoginButton() {
        WebElement loginButton = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div[2]/form/div/div[2]/div[1]/button"));;
        loginButton.click();
    }

    private void verifyErrorMessage(String expectedErrorMessage) {
        driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
        WebElement errorElement = driver.findElement(By.xpath("//html/body/div[8]/div/div/div[2]"));
        String actualErrorMessage = errorElement.getText();
        Assert.assertEquals(actualErrorMessage, expectedErrorMessage);
    }
    private void verifyemptyMessage(String errorMessage){
        driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
        WebElement errorElement = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div[2]/form/div/div[1]/div[1]/span"));
        String actualErrorMessage = errorElement.getText();
    ...
    private void verifyemptypassword(String errorpMessage){
        driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
        WebElement errorElement = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div[2]/form/div/div[1]/div[2]/span"));
        String actualErrorMessage = errorElement.getText();
